...
public class candj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_candj);
        ImageView i = (ImageView) findViewById(R.id.opensettings);

        i.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent newactivity = new Intent(candj.this, home2.class);
                startActivity(newactivity);
            }
        });
        candjdb = new sqlhelpercandj(this);
        btnViewAll = (Button) findViewById(R.id.viewallcandj);
    ...
    public void addRecord(){
        btnAddRecord.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isInserted = candjdb.addrecord(editDate.getText().toString(),
                                Integer.parseInt(editWeight.getText().toString()),
                                Integer.parseInt(editReps.getText().toString()));
                        if(isInserted= true){
                            Toast.makeText(candj.this,"Data Added!",Toast.LENGTH_LONG).show();
                            editDate.setText("");
                            editWeight.setText("");
                            editReps.setText("");
                        } else
                            Toast.makeText(candj.this,"Data cannot be added",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
